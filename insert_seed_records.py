...
try:
    c.execute("INSERT INTO appointments (customer_first, customer_last, appt_datetime, pet_name, phone_no, comments, appt_status) VALUES ('Maik', 'Maurice', '2025-09-01 14:00:00', 'Impression', '0465100200', 'This is a sample comment', 1);")
